...
public class UploadActivity extends ListActivity {
    ...
    private static final int CAMERA = 306;
    private static final int  PIC_CROP = 316;
    private static int attachedImages = 3;
    ...
    long getcurrentTimeForPic;
    public static final String HIDDEN_FOLDER = ".mpAssignment/addPhotos";
    Uri picUri;
    String photoPath = "";
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == UPLOAD_REQUEST_CODE) {
            ...
            beginUpload(finalFile.getAbsolutePath());
    ...
    private void showSelectImageDialog() {
        ...
        pictureDialog.setTitle(R.string.choose_source);
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        switch (which) {
                            case 0:
                                ...
                                break;
                            case 1:
                                // Start the camera and take a snap
                                takePhotoFromCamera();
                                //performCrop();
                                break;
                        }
    ...
    /**
     * This function send an intent to the camera and gets the
     * image from camera.
     */
